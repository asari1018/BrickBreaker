...
#pragma OPENCL EXTENSION cl_khr_byte_addressable_store : enable//19B11212 Arisa Kohtani
...
__kernel void Filter(const int width, const int height, 
  ...
  int g = (bound((A_C_0+B_C_0)*scale/1600)*0.072169f + 
            bound((A_C_1+B_C_1)*scale/1600)*0.715160f +
            bound((A_C_2+B_C_2)*scale/1600)*0.212671f);
